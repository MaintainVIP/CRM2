...
<table border="0" cellspacing="0" cellpadding="0" class="wukuang" width="100%">
    <tr>
        ...
        <td width="57%" align="right">
            <%--添加职务 --%>
            <a href="${pageContext.request.contextPath}/addOrEditPost.action">
    ...
    <s:iterator value="posts" var="post">
        <tr class="tabtd1">
            ...
            <td width="7%" align="center">
                <a href="${pageContext.request.contextPath}/addOrEditPost.action?postId=${post.postId}&postName=${post.postName}&dept.deptId=${post.dept.deptId}"><img
