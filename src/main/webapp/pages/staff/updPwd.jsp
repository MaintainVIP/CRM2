...
<body class="updpwd">
	<form action="${pageContext.request.contextPath}/editLoginPassword.action" method="post">
		<table style="width: 200px">
			...
			<s:actionerror cssStyle="color: #ff7077"/>
			<s:fielderror/>
			<tr>
				<td>原始密码：</td>
			...
			<tr>
				<td>确认密码：</td>
				<td><input type="password" name="reNewPwd" value=""/></td>
			</tr>
			<tr>
				<td colspan="2">
